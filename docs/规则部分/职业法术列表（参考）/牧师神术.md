...
丧志术（Doom）：一个受术者的攻击掷骰、伤害掷骰、豁免检定和其他检定 –2。
...
（完美圣斗士）惑人映像（Bewildering Visions）：受术者恶心或者反胃
...
（万法大全）星界居所（Astral Hospice M）：处于星界时，创建一个可以自然恢复的半位面。
...
（沙暴之书）水墙术（Wall of Water）：墙壁阻碍运动，并可以溺毙生物。
...
（死者之书）腐囊爆裂（necrotic burst）：杀死腐囊感染体，腐囊获得解放成为鬼祟腐囊。
...
（万法大全）燃法徽记（Symbol of Spell Loss）：设置符文吸收还未释放的法术。
...
（战斗英雄）圣化战场（Consecrate BattlefieldM）：将一大片区域充满正能量，使不死生物变得虚弱。
...
虚弱徽记（Symbol of Weakness M）：触发的神符可以使临近的生物虚弱。
...
（万法大全）群体法术抗力（Spell Resistance,Mass）：如同法术抗力，但是可以影响多个生物。
...
（玩家手册2）连环驱散（Chain Dispel）：解除多个目标身上的魔法。
...
(邪魔释典I)弃避混沌（Shun the Dark ChaosX）：将目标的一个渊裔专长交换为其他类型的专长。

(邪魔释典II) 角魔授力（Investiture Of The Horned Devil）：受术者成功的近战攻击能震慑敌人。
...
缚魂术（Soul Bind F）：囚禁一个新死去的灵魂使他不受复生术作用。

复仇风暴（Storm of Vengeance）：混合着酸雨、闪电和冰雹的风暴。

九级怪物召唤术（Summon Monster IX）：召唤跨位面生物为你作战。

完全复生术（True Resurrection M）：与复生术相同，但是不需要遗骸。

（玩家手册2）召唤魔像（Summon Golem）：从相似的物质中召唤一个土魔像，血魔像或者铁魔像。

（死者之书）腐囊终结（Necrotic Termination）：永久消灭腐囊感染体。

（异怪书）(邪魔释典I)剥夺术（Despoil）：杀死植物并破坏范围内其他物体，每级100尺半径。

（好人书）终结争执（End of Strife）：在施法者80英尺范围内作出攻击行为导致攻击者受到1d6/每施法等级的致命或者非致命伤害（上限为20d6）。

（好人书）升华的欢乐（Sublime Revelry）：目标免疫痛苦和心智影响效果，只受到一半的近战或者远程伤害。

（万法大全）深渊军团（Abyssal Army）：召唤恶魔为你战斗。

（万法大全）构装启智术（Awaken Construct X）：给予构装生物类人的心智。

（万法大全）呼唤刽子手（Call Marut X）：呼唤一名刽子手的帮助。

（万法大全）天国军团（Heavenly Host）：呼唤执政官（Archons）为你战斗。

（万法大全）地狱军团（Hellish Horde）：召唤魔鬼为你战斗。

（万法大全）地狱猎手（Hunters of Hades M）：召唤PACK FIEND或狩魔蛛听从你的指令。

（死者之书）（万法大全）亡灵天灾（Plague of Undead M）：唤起大群不死生物

（完美奥术）（万法大全）召唤元素巨怪（Summon Elemental Monolith）：召唤一只强大的元素巨怪为你战斗。

（万法大全）亡灵天敌（Undeath's Eternal Foe）：受术者免疫负能量和大多数不死生物的特殊攻击。

（万法大全）邪灵术（Vile Death MX）：不死生物获得炼狱模版。

（万法大全）高等神之面容（Visage of the Deity,Greater）：如同次级神之面容，但你获得半天界生物或半炼狱生物的特性。

（ECS）救世宴（Feast of Champions）：每施法者等级 1 名生物的筵席，治疗并提供各种加值。
...
(邪魔释典II) 狱火战甲授力（Investiture Of The Hellfire Engine）：受术者得到钢铁躯体和8D10地狱火的喷吐武器。

(邪魔释典II) 深渊炼魔授力（Investiture Of The Pit Fiend）：受术者获得强力的爪子攻击，对敌人造成疾病的能力，或对敌人造成恐怖的能力。

(邪魔释典II) 正义驱逐（Righteous Exile）：伤害邪恶生物并且驱逐邪恶异界生物。